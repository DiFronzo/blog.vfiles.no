...
My GA-alternative of choice is [Ackee](https://github.com/electerious/Ackee). It took me all of 10 minutes to set up using the [helm chart](https://github.com/suda/ackee-chart) (admittedly, longer than Google Analytic’s 30-second copy and paste), it shows me the stats I care about in a clean UI, it’s open-source, and it’s self-hosted.
